		...
		<div class="content-panel">
			<div class="table-responsive">
				<table class="table table-bordered dash">
					<tbody>
						<tr>
							<td class="text-center"><a href="<?= site_url('items'); ?>"><i class="fa fa-barcode"></i> <span><?= lang('items'); ?></span></a></td>
							...
							<td class="text-center"><a href="<?= site_url('settings/updates'); ?>"><i class="fa fa-upload"></i> <span><?= lang('updates'); ?></span></a></td>
							<?php } ?>
						</tr>
					</tbody>
				</table>
